...
title: "NYTimes:Blogs: Popular classification:: NYTBlogs3_feat_PubDate"
author: "bdanalytics"
...
if (nrow(dupObsAll) > 0) {
    ...
    print(subset(dupgrps_df, (Popular.NA > 0)))
...
if (!is.numeric(glbObsAll[, glb_id_var]))
    ...
    print(myplot_histogram(glbObsAll, glb_id_var) + facet_wrap(as.formula(paste0("~", glb_rsp_var_raw))))
