...
title: "NYTimes:Blogs: Popular classification:: NYTBlogs3_base"
author: "bdanalytics"
...
setwd("~/Documents/Work/Courses/MIT/Analytics_Edge_15_071x/Assignments/Kaggle_NYTimes_blogs3")
```
...
glb_sel_mdl_id <- "All.X**repeatedcv*glmnet" #select from c(NULL, "All.X##repeatedcv#glmnet", "RFE.X##repeatedcv#glmnet", <mdlId>)
...
myget_category_stats <- function(obs_df, mdl_id, label) {
    ...
    tmp_obs_df <- obs_df[, c(glb_category_var, glb_rsp_var, 
